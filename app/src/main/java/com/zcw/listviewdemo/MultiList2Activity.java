...
public class MultiList2Activity extends AppCompatActivity {
    ...
    private void init() {
        ...
        tvCancel = llMultiChoiceTitle.findViewById(R.id.tv_multi_choice_cancel2);
        tvChoiceCount = llMultiChoiceTitle.findViewById(R.id.tv_multi_choice_count2);
        tvChoiceAllOrNone = llMultiChoiceTitle.findViewById(R.id.tv_multi_choice_all_none2);
        imgDelete = findViewById(R.id.img_multi_delete2);
        tvChoiceResult = findViewById(R.id.tv_multi_choice_result2);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                CommonUtils.toast(MultiList2Activity.this, data.get(position) + " Choice!!!");
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                CommonUtils.toast(MultiList2Activity.this, "Long click " + data.get(position));
        ...
        imgDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(listView.getCheckedItemCount() == 0) {
                    CommonUtils.toast(MultiList2Activity.this, R.string.choice_delete_item);
                    return ;
                }

                final CustomDialog dialog = new CustomDialog(MultiList2Activity.this);
    ...
    private static class Multi2Adapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(view == null) {
                ...
                holder.imgChecked = view.findViewById(R.id.img_multi_item_content2);
                view.setTag(holder);
            }
            else {
